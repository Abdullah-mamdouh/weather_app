...
import 'presentation/bloc/theme_bloc/cubit.dart';
import 'presentation/pages/login_page/login_page.dart';
import 'presentation/pages/manager_page/manager_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        ...
        BlocProvider<ThemeBloc>(create: (context) => ThemeBloc()..initialColor()),
        //BlocProvider<LocationBloc>(create: (context) => LocationBloc()..getMyLocation()),
    ],
    child: MaterialApp(
    debugShowCheckedModeBanner: false,
    title: 'Posts App',
    home: //UserInfoWidget()//ManagerPage()//
      LoginPage()
